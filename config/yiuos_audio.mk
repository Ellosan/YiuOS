...
ALARM_PATH := vendor/yiuos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/yiuos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/yiuos/prebuilt/common/media/audio/ringtones
