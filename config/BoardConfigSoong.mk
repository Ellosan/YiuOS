...
$(call add_soong_config_namespace,yiuosVarsPlugin)
$(foreach v,$(EXPORT_TO_SOONG),$(eval $(call add_soong_config_var,yiuosVarsPlugin,$(v))))

# Bootanimation
TARGET_BOOTANIMATION_HALF_RES ?= false
$(call soong_config_set,yiuos_bootanimation,height,$(TARGET_SCREEN_HEIGHT))
$(call soong_config_set,yiuos_bootanimation,width,$(TARGET_SCREEN_WIDTH))
$(call soong_config_set,yiuos_bootanimation,half_res,$(TARGET_BOOTANIMATION_HALF_RES))

ifneq ($(TARGET_BOOTANIMATION),)
$(call soong_config_set,yiuos_bootanimation,prebuilt_file,$(TARGET_BOOTANIMATION))
endif

# Charger
yiuos_charger_density := mdpi
ifneq (,$(TARGET_SCREEN_DENSITY))
yiuos_charger_density := $(strip \
...
yiuos_charger_density := $(PRODUCT_AAPT_PREF_CONFIG)
endif
$(call soong_config_set,yiuos_charger,density,$(yiuos_charger_density))
